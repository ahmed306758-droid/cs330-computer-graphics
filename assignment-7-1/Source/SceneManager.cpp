...
void SceneManager::PrepareScene()
{
    ...
    // Textures
    CreateGLTexture("textures/wood.jpeg", "wood");
 ...
 * DefineObjectMaterials()
 *
 * Creates materials used by the Phong lighting model
 ****************************************************************/
void SceneManager::DefineObjectMaterials()
{
	...
	material.diffuseColor = glm::vec3(0.7f, 0.5f, 0.3f);
	...
	material.specularColor = glm::vec3(0.8f, 0.8f, 0.8f);
	...
	// Screen Material
	material.ambientStrength = 0.3f;
	material.ambientColor = glm::vec3(0.2f, 0.2f, 0.3f);
	material.diffuseColor = glm::vec3(0.4f, 0.4f, 0.8f);
	material.specularColor = glm::vec3(1.0f, 1.0f, 1.0f);
 ...
 * SetupSceneLights()
 *
 * Creates a directional light and a fill light
 ****************************************************************/
void SceneManager::SetupSceneLights()
{
	...
	// Camera position
	m_pShaderManager->setVec3Value("viewPosition",
		0.0f, 8.0f, 15.0f);
	...
	// =========================
	// 2. KEY LIGHT (warm orange point light)
	// =========================
	...
	m_pShaderManager->setVec3Value("pointLights[0].diffuse",
		glm::vec3(1.0f, 0.7f, 0.4f)); // warm tone
	...
	// =========================
	// 3. FILL LIGHT (cool blue/purple light)
	// =========================
	...
	m_pShaderManager->setVec3Value("pointLights[1].diffuse",
		glm::vec3(0.2f, 0.4f, 1.0f)); // blue light
...
void SceneManager::RenderScene()
{
	...
	positionXYZ = glm::vec3(-4.5f, 1.25f, -2.5f);
	...
	positionXYZ = glm::vec3(0.0f, 4.3f, -1.0f);
	...
	scaleXYZ = glm::vec3(2.2f, 1.2f, 0.05f);
	positionXYZ = glm::vec3(0.0f, 4.3f, -0.85f);
	...
	positionXYZ = glm::vec3(0.0f, 2.6f, -0.9f);
	...
	scaleXYZ = glm::vec3(1.0f, 2.0f, 0.8f);
	positionXYZ = glm::vec3(0.0f, 2.65f, -1.4f);
	SetTransformations(
		scaleXYZ,
		0.0f,
		0.0f,
	...
	scaleXYZ = glm::vec3(1.0f, 2.0f, 1.2f);
	positionXYZ = glm::vec3(3.5f, 3.5f, -1.5f);
	...
	positionXYZ = glm::vec3(-2.5f, 3.0f, 0.5f);
	...
	SetShaderTexture("ceramic");
	SetShaderMaterial("ceramic");
	scaleXYZ = glm::vec3(0.22f, 0.12f, 0.12f);
	positionXYZ = glm::vec3(-1.95f, 3.20f, 0.50f);
