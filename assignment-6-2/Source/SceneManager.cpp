...
void SceneManager::SetupSceneLights()
{
	...
	// =========================
	m_pShaderManager->setVec3Value("pointLights[0].position", glm::vec3(0.7f, 2.0f, 2.0f));
	m_pShaderManager->setVec3Value("pointLights[0].ambient", glm::vec3(0.25f));
	...
	// SECOND LIGHT (colored)
	m_pShaderManager->setVec3Value("pointLights[1].position", glm::vec3(-3.0f, 3.0f, -2.0f));
	m_pShaderManager->setVec3Value("pointLights[1].ambient", glm::vec3(0.1f, 0.05f, 0.2f));
	m_pShaderManager->setVec3Value("pointLights[1].diffuse", glm::vec3(0.3f, 0.2f, 0.8f));
	m_pShaderManager->setVec3Value("pointLights[1].specular", glm::vec3(0.6f, 0.6f, 1.0f));
...
void SceneManager::RenderScene()
{
	...
	positionXYZ = glm::vec3(3.2f, 4.9f, 2.5f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	...
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.0f);
	positionXYZ = glm::vec3(3.2f, 3.5f, 2.5f); // Positioning it directly underneath the sphere
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	...
	positionXYZ = glm::vec3(-3.3f, 3.00f, 2.0f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
