...
void SceneManager::LoadSceneTextures()
{
	...
	// Brick texture for pyramid
	CreateGLTexture(
		"./textures/brick.jpg",
		"Brick");

	// Second texture for another object
	CreateGLTexture(
...
void SceneManager::RenderScene()
{
	...
	/****************************************************************/
/* Brick textured pyramid                                       */
/****************************************************************/
	/****************************************************************/
/* Pyramid on left side of seesaw                              */
/****************************************************************/

	/****************************************************************/
/* Brick textured pyramid on seesaw                            */
/****************************************************************/
	...
	positionXYZ = glm::vec3(-2.8f, 3.5f, 1.9f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 0.8f, 0.4f);
